  ...
  <body>
    <div class="main">
        ...
        <div class="mainmenue">
          ...
          <a  href="gallery.php">Team Members</a>
        </div>
        <div class="mainbody">
          ...
          <div class="lictslider lictslider-section" style="float:right;width:40%; height:280px;margin-top:50px;">
            <img class="lictslides" src="img/slider0.jpg" style="width:380px; height:260px;">
            <img class="lictslides" src="img/slider1.jpg" style="width:380px; height:260px;">
            <img class="lictslides" src="img/slider2.jpg" style="width:380px; height:260px;">
            <img class="lictslides" src="img/slider3.jpg" style="width:380px; height:260px;">
            <img class="lictslides" src="img/slider4.jpg" style="width:380px; height:260px;">
            <img class="lictslides" src="img/slider5.jpg" style="width:380px; height:260px;">
            <img class="lictslides" src="img/slider6.jpg" style="width:380px; height:260px;">
            <img class="lictslides" src="img/slider7.jpg" style="width:380px; height:260px;">
            <img class="lictslides" src="img/slider9.jpg" style="width:380px; height:260px;">
